...
namespace AvaloniaSample.Diagram;

public partial class DiagramUserControl : UserControl
{
    private Northwoods.Go.Diagram _Diagram;
    public DiagramUserControl()
    {      
        InitializeComponent();
        _Diagram = DiagramControl.Diagram;
        Setup();
    }
    ...
    public class NodeData : GraphLinksModel<NodeData, string, object, LinkData, string, string>.NodeData { }
    public class LinkData : GraphLinksModel<NodeData, string, object, LinkData, string, string>.LinkData { }
}